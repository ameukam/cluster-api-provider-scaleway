...
func (r *ScalewayClusterReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	_ = context.Background()
	_ = r.Log.WithValues("scalewaycluster", req.NamespacedName)
...
func (r *ScalewayClusterReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&infrastructurev1alpha3.ScalewayCluster{}).
		Complete(r)
}
